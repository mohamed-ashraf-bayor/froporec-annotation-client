...
@javax.annotation.processing.Generated(
    ...
    date = "2022-12-30T21:03:44.1635545-05:00",
...
public record ImmutablePerson(java.lang.String lastname, int age)  {
	...
	public static ImmutablePerson buildWith(com.bayor.froporec.annotation.client.immutable.data3_methodparametersannotated.Person person) {
		return new ImmutablePerson(person.lastname(), person.age());
	}

	public static ImmutablePerson buildWith(com.bayor.froporec.annotation.client.immutable.data3_methodparametersannotated.ImmutablePerson immutablePerson) {
	...
	@java.lang.SuppressWarnings("unchecked")
	public static ImmutablePerson buildWith(com.bayor.froporec.annotation.client.immutable.data3_methodparametersannotated.Person person, java.util.Map<String, Object> fieldsNameValuePairs) {
	...
	@java.lang.SuppressWarnings("unchecked")
	public static ImmutablePerson buildWith(com.bayor.froporec.annotation.client.immutable.data3_methodparametersannotated.ImmutablePerson immutablePerson, java.util.Map<String, Object> fieldsNameValuePairs) {
