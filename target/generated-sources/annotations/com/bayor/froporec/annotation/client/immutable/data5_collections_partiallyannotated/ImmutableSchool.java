...
@javax.annotation.processing.Generated(
    ...
    date = "2022-12-30T21:03:44.0885565-05:00",
...
public record ImmutableSchool(java.lang.String name)  {
	...
	public static ImmutableSchool buildWith(com.bayor.froporec.annotation.client.immutable.data5_collections_partiallyannotated.School school) {
		return new ImmutableSchool(school.name());
	}

	public static ImmutableSchool buildWith(com.bayor.froporec.annotation.client.immutable.data5_collections_partiallyannotated.ImmutableSchool immutableSchool) {
	...
	@java.lang.SuppressWarnings("unchecked")
	public static ImmutableSchool buildWith(com.bayor.froporec.annotation.client.immutable.data5_collections_partiallyannotated.School school, java.util.Map<String, Object> fieldsNameValuePairs) {
		return new ImmutableSchool((java.lang.String) fieldsNameValuePairs.getOrDefault(NAME, school.name()));
	}

	@java.lang.SuppressWarnings("unchecked")
	public static ImmutableSchool buildWith(com.bayor.froporec.annotation.client.immutable.data5_collections_partiallyannotated.ImmutableSchool immutableSchool, java.util.Map<String, Object> fieldsNameValuePairs) {
