...
@javax.annotation.processing.Generated(
    ...
    date = "2022-12-30T21:03:43.9265544-05:00",
...
public record PersonRecord(java.lang.String lastname, int age)  {
	...
	public static PersonRecord buildWith(com.bayor.froporec.annotation.client.mixed.Person person) {
		return new PersonRecord(person.getLastname(), person.getAge());
	}

	public static PersonRecord buildWith(com.bayor.froporec.annotation.client.mixed.PersonRecord personRecord) {
	...
	@java.lang.SuppressWarnings("unchecked")
	public static PersonRecord buildWith(com.bayor.froporec.annotation.client.mixed.Person person, java.util.Map<String, Object> fieldsNameValuePairs) {
	...
	@java.lang.SuppressWarnings("unchecked")
	public static PersonRecord buildWith(com.bayor.froporec.annotation.client.mixed.PersonRecord personRecord, java.util.Map<String, Object> fieldsNameValuePairs) {
