...
@javax.annotation.processing.Generated(
    ...
    date = "2023-01-02T14:58:47.6970308-05:00",
...
public record ImmutableSchool(java.lang.String name)  {
	...
	public static ImmutableSchool buildWith(com.bayor.froporec.annotation.client.immutable.data4_collectionsannotated.School school) {
		return new ImmutableSchool(school.name());
	}

	public static ImmutableSchool buildWith(com.bayor.froporec.annotation.client.immutable.data4_collectionsannotated.ImmutableSchool immutableSchool) {
	...
	@java.lang.SuppressWarnings("unchecked")
	public static ImmutableSchool buildWith(com.bayor.froporec.annotation.client.immutable.data4_collectionsannotated.School school, java.util.Map<String, Object> fieldsNameValuePairs) {
		return new ImmutableSchool((java.lang.String) fieldsNameValuePairs.getOrDefault(NAME, school.name()));
	}

	@java.lang.SuppressWarnings("unchecked")
	public static ImmutableSchool buildWith(com.bayor.froporec.annotation.client.immutable.data4_collectionsannotated.ImmutableSchool immutableSchool, java.util.Map<String, Object> fieldsNameValuePairs) {
