...
@javax.annotation.processing.Generated(
    ...
    date = "2022-12-28T21:36:09.2598811-05:00",
...
public record SchoolRecord(java.lang.String name)  {
	...
	public static SchoolRecord buildWith(com.bayor.froporec.annotation.client.record.data2_fieldsannotated.School school) {
		return new SchoolRecord(school.getName());
	}

	public static SchoolRecord buildWith(com.bayor.froporec.annotation.client.record.data2_fieldsannotated.SchoolRecord schoolRecord) {
	...
	@java.lang.SuppressWarnings("unchecked")
	public static SchoolRecord buildWith(com.bayor.froporec.annotation.client.record.data2_fieldsannotated.School school, java.util.Map<String, Object> fieldsNameValuePairs) {
		return new SchoolRecord((java.lang.String) fieldsNameValuePairs.getOrDefault(NAME, school.getName()));
	}

	@java.lang.SuppressWarnings("unchecked")
	public static SchoolRecord buildWith(com.bayor.froporec.annotation.client.record.data2_fieldsannotated.SchoolRecord schoolRecord, java.util.Map<String, Object> fieldsNameValuePairs) {
