...
@javax.annotation.processing.Generated(
    ...
    date = "2022-12-28T21:36:09.3118796-05:00",
...
public record PersonRecord(java.lang.String lastname, int age)  {
	...
	public static PersonRecord buildWith(com.bayor.froporec.annotation.client.record.data1_allclassesannotated.Person person) {
		return new PersonRecord(person.getLastname(), person.getAge());
	}

	public static PersonRecord buildWith(com.bayor.froporec.annotation.client.record.data1_allclassesannotated.PersonRecord personRecord) {
	...
	@java.lang.SuppressWarnings("unchecked")
	public static PersonRecord buildWith(com.bayor.froporec.annotation.client.record.data1_allclassesannotated.Person person, java.util.Map<String, Object> fieldsNameValuePairs) {
	...
	@java.lang.SuppressWarnings("unchecked")
	public static PersonRecord buildWith(com.bayor.froporec.annotation.client.record.data1_allclassesannotated.PersonRecord personRecord, java.util.Map<String, Object> fieldsNameValuePairs) {
