...
@javax.annotation.processing.Generated(
    ...
    date = "2023-01-02T14:58:47.7070295-05:00",
...
public record ImmutableSchool(java.lang.String name)  {
	...
	public static ImmutableSchool buildWith(com.bayor.froporec.annotation.client.immutable.data3_methodparametersannotated.School school) {
		return new ImmutableSchool(school.name());
	}

	public static ImmutableSchool buildWith(com.bayor.froporec.annotation.client.immutable.data3_methodparametersannotated.ImmutableSchool immutableSchool) {
	...
	@java.lang.SuppressWarnings("unchecked")
	public static ImmutableSchool buildWith(com.bayor.froporec.annotation.client.immutable.data3_methodparametersannotated.School school, java.util.Map<String, Object> fieldsNameValuePairs) {
		return new ImmutableSchool((java.lang.String) fieldsNameValuePairs.getOrDefault(NAME, school.name()));
	}

	@java.lang.SuppressWarnings("unchecked")
	public static ImmutableSchool buildWith(com.bayor.froporec.annotation.client.immutable.data3_methodparametersannotated.ImmutableSchool immutableSchool, java.util.Map<String, Object> fieldsNameValuePairs) {
