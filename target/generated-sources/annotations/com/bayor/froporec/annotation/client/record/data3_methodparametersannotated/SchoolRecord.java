...
@javax.annotation.processing.Generated(
    ...
    date = "2023-01-02T14:58:47.4930285-05:00",
...
public record SchoolRecord(java.lang.String name)  {
	...
	public static SchoolRecord buildWith(com.bayor.froporec.annotation.client.record.data3_methodparametersannotated.School school) {
		return new SchoolRecord(school.getName());
	}

	public static SchoolRecord buildWith(com.bayor.froporec.annotation.client.record.data3_methodparametersannotated.SchoolRecord schoolRecord) {
	...
	@java.lang.SuppressWarnings("unchecked")
	public static SchoolRecord buildWith(com.bayor.froporec.annotation.client.record.data3_methodparametersannotated.School school, java.util.Map<String, Object> fieldsNameValuePairs) {
		return new SchoolRecord((java.lang.String) fieldsNameValuePairs.getOrDefault(NAME, school.getName()));
	}

	@java.lang.SuppressWarnings("unchecked")
	public static SchoolRecord buildWith(com.bayor.froporec.annotation.client.record.data3_methodparametersannotated.SchoolRecord schoolRecord, java.util.Map<String, Object> fieldsNameValuePairs) {
