...
@javax.annotation.processing.Generated(
    ...
    date = "2023-01-02T14:58:47.5040281-05:00",
...
public record PersonRecord(java.lang.String lastname, int age)  {
	...
	public static PersonRecord buildWith(com.bayor.froporec.annotation.client.record.data2_fieldsannotated.Person person) {
		return new PersonRecord(person.getLastname(), person.getAge());
	}

	public static PersonRecord buildWith(com.bayor.froporec.annotation.client.record.data2_fieldsannotated.PersonRecord personRecord) {
	...
	@java.lang.SuppressWarnings("unchecked")
	public static PersonRecord buildWith(com.bayor.froporec.annotation.client.record.data2_fieldsannotated.Person person, java.util.Map<String, Object> fieldsNameValuePairs) {
	...
	@java.lang.SuppressWarnings("unchecked")
	public static PersonRecord buildWith(com.bayor.froporec.annotation.client.record.data2_fieldsannotated.PersonRecord personRecord, java.util.Map<String, Object> fieldsNameValuePairs) {
