...
public class BusinessLogic {
    ...
    private static void processData(@GenerateRecord(includeTypes = Student.class) Person person, @GenerateImmutable(includeTypes = BuildingInfo.class) School school) {
